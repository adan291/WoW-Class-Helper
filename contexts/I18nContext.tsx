...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'selection.subtitle':
      'Elige tu clase para obtener guías, consejos y estrategias impulsadas por IA.',
  ...
  fr: {
    ...
    'selection.subtitle':
      'Choisissez votre classe pour obtenir des guides, conseils et stratégies alimentés par IA.',
  ...
  pt: {
    ...
    'selection.subtitle':
      'Escolha sua classe para obter guias, dicas e estratégias alimentadas por IA.',
