...
export const MonkIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    {/* Top half - white */}
    <path d="M32 18 A14 14 0 0 1 32 46 A7 7 0 0 1 32 32 A7 7 0 0 0 32 18 Z" fill="#ffffff" opacity="0.95" />
    {/* Bottom half - dark */}
    <path d="M32 46 A14 14 0 0 1 32 18 A7 7 0 0 1 32 32 A7 7 0 0 0 32 46 Z" fill="#1a1a1a" opacity="0.95" />
