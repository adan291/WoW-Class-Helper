...
export const PriestIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <rect x="29" y="9" width="6" height="46" fill="none" stroke="#ffffff" strokeWidth="0.5" opacity="0.6" />
    <rect x="15" y="25" width="34" height="6" fill="none" stroke="#ffffff" strokeWidth="0.5" opacity="0.6" />
    {/* Light rays */}
    <path d="M20 16 L18 12 M44 16 L46 12 M20 48 L18 52 M44 48 L46 52" stroke="#ffd700" strokeWidth="1.5" strokeLinecap="round" />
    {/* Divine aura */}
