  ...
  if (success) {
    return (
      <div className="text-center space-y-4">
        <div className="text-green-500 text-lg font-semibold">✓ Registration Successful!</div>
        <p className="text-gray-400 text-sm">Please check your email to verify your account.</p>
      </div>
    );
  }
